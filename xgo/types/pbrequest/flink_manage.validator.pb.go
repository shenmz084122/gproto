...
var _xxx_xxx_Validator_CreateFlinkCluster_In_Version = map[string]bool{"flink-1.12.3-scala_2.11": true, "flink-1.12.3-scala_2.11-q0.9": true, "flink-1.12.3-scala_2.11-cj_1.12": true, "flink-1.14.5-scala_2.11": true, "flink-1.17.2-scala_2.12": true}
...
func (this *CreateFlinkCluster) _xxx_xxx_Validator_Validate_version() error {
	if !(_xxx_xxx_Validator_CreateFlinkCluster_In_Version[this.Version]) {
		return protovalidator.FieldError1("CreateFlinkCluster", "the value of field 'version' must be one of '[flink-1.12.3-scala_2.11 flink-1.12.3-scala_2.11-q0.9 flink-1.12.3-scala_2.11-cj_1.12 flink-1.14.5-scala_2.11 flink-1.17.2-scala_2.12]'", this.Version)
	}
	return nil
}
